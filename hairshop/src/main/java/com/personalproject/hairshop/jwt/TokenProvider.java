...
import com.personalproject.hairshop.service.CustomUserDetailsService;
...
public class TokenProvider implements InitializingBean {
	...
	public Authentication getAuthentication(String token) {
		...
		UserDto userDto = (UserDto) customUserDetailsService.loadUserByUsername(claims.getSubject());
